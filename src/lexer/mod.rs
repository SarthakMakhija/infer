...
impl<'a> Lexer<'a> {
    ...
    pub(crate) fn next(&mut self) -> Result<Token<'a>, LexError> {
    ...
    fn next_token(&mut self) -> Option<(usize, char)> {
        self.chars.next()
    }
...
mod tests {
    ...
    fn lex_equals() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 1..1);
    }
    ...
    fn lex_identifier() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 4..4);
    }
    ...
    fn lex_identifier_with_underscore() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 10..10);
    }
    ...
    fn lex_var_keyword() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 3..3);
    }
    ...
    fn lex_whole_number() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 6..6);
    }
    ...
    fn lex_var_declaration() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 18..18);
    }
    ...
    fn lex_var_declaration_with_type() {
        ...
        assert_token!(lexer.next(), TokenType::Eof, 26..26);
    }
}
